    ...
    return (
        <div className={styles.employeeItemContainer}>
            ...
            <div className={styles.employeeItemInfoContainer}>
                <p>{t('domainEmailLabel')}: {employee.domain_email}</p>
                <p>{t('emailLabel')}: {employee.email}</p>
            ...
            <Modal setActive={setIsModalActive} active={isModalActive}>
                <ErrorString errorText={errorString} />
            </Modal>
            <Modal setActive={setRoleModalActive} active={isRoleModalActive}>
                <EmployeeRole employee={employee} onSuccess={handleSuccess} />
            </Modal>
        </div>
    );
});
